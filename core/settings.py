...
SECRET_KEY = 'django-insecure-lr%#@#vw&c*_#4chnhqit&qu5)ktef8hxs-%r4h0m+z_=0yoz)'
...
# Qo'shimcha static papkalar (agar kerak bo'lsa)
STATICFILES_DIRS = [
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # development uchun
    ],
